...
const MarketPlace = () => {
  ...
  const products = [
    {
      id: 1,
      title: getTranslation('marketplace.productTomatoes', language),
      price: '₹45/kg',
      description: getTranslation('marketplace.productTomatoesDesc', language),
      image: imgTomatoes,
      cta: getTranslation('buyNow', language)
    },
    {
      id: 2,
      title: getTranslation('marketplace.productOnions', language),
      price: '₹35/kg',
      description: getTranslation('marketplace.productOnionsDesc', language),
      image: imgOnions,
      cta: getTranslation('buyNow', language)
    },
    {
      id: 3,
      title: getTranslation('marketplace.productPotatoes', language),
      price: '₹25/kg',
      description: getTranslation('marketplace.productPotatoesDesc', language),
      image: imgPotatoes,
      cta: getTranslation('buyNow', language)
    },
    {
      id: 4,
      title: getTranslation('marketplace.productRice', language),
      price: '₹55/kg',
      description: getTranslation('marketplace.productRiceDesc', language),
      image: imgRice,
      cta: getTranslation('buyNow', language)
    }
  ];
  ...
  return (
    <div style={pageStyle}>
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div style={contentStyle}>
                ...
                <button className="btn-primary" style={{ width: '100%' }}>{product.cta}</button>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="container" style={{ marginTop: 'var(--spacing-xxl)' }}>
        <h2 style={{ textAlign: 'center', marginBottom: 'var(--spacing-xl)' }}>{getTranslation('marketPrices', language)}</h2>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 'var(--spacing-lg)' }}>
          {[
            ...
            <div key={idx} style={cardStyle}>
              ...
              <h4 style={{ textAlign: 'center', marginBottom: 'var(--spacing-sm)' }}>{getTranslation('marketplace.' + item.name.replace(/\s|\(|\)|\+/g, ''), language) || item.name}</h4>
