            ...
            <div className="flex items-center gap-4">
              ...
              {user ? (
                ...
                <div className="hidden md:flex gap-2">
                  <Button variant="ghost" onClick={() => UserEntity.login()}>
                    {t.login}
                  </Button>
                  <Button className="gradient-green text-white hover:opacity-90" onClick={() => UserEntity.login()}>
                    {t.signup}
                  </Button>
                </div>
              )}
                  ...
                  <nav className="mt-8 space-y-4">
                    ...
                    {!user && (
                      <div className="pt-4 space-y-2">
                        <Button className="w-full" variant="ghost" onClick={() => UserEntity.login()}>
                          {t.login}
                        </Button>
                        <Button className="w-full gradient-green text-white" onClick={() => UserEntity.login()}>
                          {t.signup}
                        </Button>
                      </div>
                    )}
